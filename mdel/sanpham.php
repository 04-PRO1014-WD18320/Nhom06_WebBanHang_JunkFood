...
function update_sanpham($iddm,$id,$tensp,$giasp,$mota,$hinh,$soluong){
    if($hinh!=""){
        $sql="update sanpham set name ='".$tensp."',iddm ='".$iddm."',price='".$giasp."',mota='".$mota."',img ='".$hinh."',soluong='".$soluong."' where id=" .$id;
    }else{
        $sql="update sanpham set name ='".$tensp."',iddm ='".$iddm."',price='".$giasp."',mota='".$mota."',soluong='".$soluong."'  where id=" .$id;
    }
